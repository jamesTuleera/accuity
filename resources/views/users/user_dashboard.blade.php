...
@section('user-content')
    <div class="content bg-dark">
        <div class="page-inner">
                                ...
                                <div class="col-7 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-light">
                                            ${{ number_format(Auth::user()->wallet->balance - Auth::user()->wallet->debit_bal) }}.00
                                        </h4> <br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-light">$
                                            {{ number_format(Auth::user()->wallet->investment) }}.00</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-light">
                                            ${{ number_format(Auth::user()->wallet->profit) }}.00</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-light">
                                            ${{ number_format(Auth::user()->wallet->bonus) }}.00</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-light">
                                            ${{ number_format(Auth::user()->wallet->ref_bonus) }}.00</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4 p-4 card bg-dark shadow-lg">
                <a href="{{ route('users.deposit') }}">
                    <img class="w-100" src="{{ asset('homeAsset/gold_plan.png') }}" alt="">
                </a>
            </div> --}}
                    ...
                    <div id="chart-page">
                        <div class="tradingview-widget-container" style="margin:30px 0px 10px 0px;">
                            ...
                            <div class="tradingview-widget-copyright"><a href="#" rel="noopener"
                                    target="_blank"><span class="blue-text"></span> <span class="blue-text">Personal
                                        trading chart</span></a>
                            </div>
