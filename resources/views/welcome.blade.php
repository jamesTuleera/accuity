        ...
        <div id="navigation" class="navbar-nav ml-auto">
            <ul class="navbar-nav mt-1">
                ...
                <li class="nav-item animated" data-animation="fadeInDown" data-animation-delay="1.3s">
                    <a class="nav-link" href="index.html#choose">Why Choose Us</a>
                </li>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="banner-content pt-5">
                            <h1 class="best-template animated" data-animation="fadeInUpShorter" data-animation-delay="1.5s">
                                <b>A DECENTRALIZED BLOCKCHAIN INFRASTRUCTURE TRADING AND INVESTMENT PLATFORM</b>
                                </h1>
                            <p class="mb-4 d-block white animated" data-animation="fadeInUpShorter" data-animation-delay="1.6s" style="text-align:justify">
                                Trading and investment platform for cryptocurrencies, foreign exchange, binary options, and CFDs that is decentralized and based on blockchain technology. With the use of blockchain technology, we provide simple, efficient, and secure trading and investment choices.
...
<coin-stats-marquee-widget locale="en" currency="USD" background="#FFFFFF" status-up-color="#4F8A5B" status-down-color="#FE4747" text-color="#1C1B1B" buttons-color="#1C1B1B" border-color="rgba(28,27,27,0.15)" position="static" font="Roboto, Arial, Helvetica" width="100%" coins-count="20" ></coin-stats-marquee-widget>
</section>
<!--/ Exchange Listing Area -->
...
<!-- Problems & Solutions -->
<section id="problem-solution choose" class="problem-solution section-pro section-padding bg-gradient" data-midnight="white">
    <div class="container-fluid">
        <div class="container">
    ...
    <div class="token-sale">
        <div class="container-fluid">
            <div class="container">
                ...
                <coin-stats-converter-widget sell-coin-id="bitcoin" buy-coin-id="ethereum" locale="en" background="#1C1B1B" text-color="#FFFFFF" border-color="rgba(255,255,255,0.15)" rotate-button-color="rgba(255,255,255,0.35)" type="large" font="Roboto, Arial, Helvetica" width="1000" ></coin-stats-converter-widget>
...
<!--/ Token Sale Mobile App -->
<section id="token-sale-mobile-app price" class="token-sale-mobile-app section-padding bg-gradient" data-midnight="white">
    <div class="token-sale">
        <div class="container-fluid">
            <div class="container">
                <div class="dark-bg-heading text-center">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 animated" data-animation="fadeInLeftShorter" data-animation-delay="0.6s" style='margin-bottom:25px'>
                                ...
                                <img src='{{ asset('homeAsset/b.png') }}' style='width:20px;border:2px solid floralwhite;border-radius: 100%;'>
                                 ...
                                 <br>
                                    ...
                                    <div class="elementor-widget-container">
                                        <h4 style="text-align:center;font-size:15px;;color:black"
                                            class="elementor-heading-title elementor-size-default">
                                            <b>Maximum Deposit</b> <i style='color:black;font-weight:bolder'> - </i> $10,000</h4>
                                    </div>
                                </div>
                                        ...
                                        <div class="elementor-widget-container">
                                            <ul class="elementor-icon-list-items">
                                                <li class="elementor-icon-list-item"> <span
                                                        ...
                                                        class="elementor-icon-list-text"  style="color:black">Risk management</span></li>
                                                <li class="elementor-icon-list-item"> <span
                                                        class="elementor-icon-list-icon"> <i
                                                            aria-hidden="true"
                                                            class="fa fa-check" style="color:black"></i>
                                                    </span> <span
                                                        class="elementor-icon-list-text"  style="color:black">Standard Options</span></li>
                                                <li class="elementor-icon-list-item"> <span
                                                        class="elementor-icon-list-icon"> <i
                                                            aria-hidden="true"
                                                            class="fa fa-check" style="color:black"></i>
                                                    </span> <span
                                                        class="elementor-icon-list-text"  style="color:black">Account manager</span></li>
                                                        <li class="elementor-icon-list-item"> <span
                                                            class="elementor-icon-list-icon"> <i
                                                                aria-hidden="true"
                                                                class="fa fa-check" style="color:black"></i>
                                                        </span> <span
                                                            class="elementor-icon-list-text" style="color:black">Contract Duration: 2-3 Weeks</span></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <img src='{{ asset('homeAsset/b.png') }}' style='width:20px;border:2px solid floralwhite;border-radius: 100%;'>
                             ...
                             <br>
                                ...
                                <div class="elementor-widget-container">
                                    <h4 style="text-align:center;font-size:15px;;color:black"
                                        class="elementor-heading-title elementor-size-default">
                                        <b>Maximum Deposit</b> <i style='color:black;font-weight:bolder'> - </i> $50,000</h4>
                                </div>
                            </div>
                                        ...
                                        <ul class="elementor-icon-list-items">
                                            ...
                                            <li class="elementor-icon-list-item"> <span
                                                    ...
                                                    <li class="elementor-icon-list-item"> <span
                                                        ...
                                                        class="elementor-icon-list-text" style="color:black">Contract Duration: 3-4 Weeks</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="token-details text-center">
                        ...
                        <br>
                            ...
                            <div class="elementor-widget-container">
                                <h4 style="text-align:center;font-size:15px;;color:black"
                                    class="elementor-heading-title elementor-size-default">
                                    <b>Maximum Deposit</b> <i style='color:black;font-weight:bolder'> - </i> UNLIMITED</h4>
                            </div>
                        </div>
                                    ...
                                    <ul class="elementor-icon-list-items">
                                        ...
                                        <li class="elementor-icon-list-item"> <span
                                                ...
                                                <li class="elementor-icon-list-item"> <span
                                                    ...
                                                    class="elementor-icon-list-text" style="color:black">Contract Duration: 6 Weeks</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
			...
			<div class="col-md-4">
				<div class="links">
					...
					<ul class="useful-links float-left mr-5">
						<li class="animated" data-animation="fadeInUpShorter" data-animation-delay="0.6s"><a href="index.html">Home</a></li>
						<li class="animated" data-animation="fadeInUpShorter" data-animation-delay="0.7s"><a href="index.html#about">About Us</a></li>
						<li class="animated" data-animation="fadeInUpShorter" data-animation-delay="0.8s"><a href="index.html#choose">Why Choose Us </a></li>
					</ul>
					<ul class="useful-links">
						<li class="animated" data-animation="fadeInUpShorter" data-animation-delay="0.9s"><a href="index.html#price">Pricing</a></li>
						<li class="animated" data-animation="fadeInUpShorter" data-animation-delay="1.0s"><a href="index.html#faq">Faq</a></li>
						<li class="animated" data-animation="fadeInUpShorter" data-animation-delay="1.1s"><a href="ndex.html#contact">Contact Us</a></li>
					</ul>
